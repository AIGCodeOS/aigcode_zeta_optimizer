...
MASTER_PORT=${USER_MASTER_PORT:-6004}
...
TOKENIZER_PATH="/sharedata/ckw/model_from_hf/gpt2"
EXP_NAME="gpt2_small_${OPTIMIZER}_lr${LR}"
...
torchrun ${DISTRIBUTED_ARGS} pretrain_gpt.py \
  ...
  --save ${CKPT_SAVE_DIR} \
  --load ${CKPT_SAVE_DIR} \
  | tee logs/pretrain_gpt2_small_sophiamuon.log
