...
class RequirementsBasicFeature(MindspeedRequirementsBasicFeature):
    ...
    def register_args(self, parser: ArgumentParser):
        ...
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'zeta')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'zetav11')
        ...
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'adamuonsophia')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'lion')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'lionmuon')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'mixmuon')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'adamuonstable')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'zetasoliton')
        self.add_parser_argument_choices_value(parser, "--optimizer-selection", 'muonmagma')
    ...
    def optimizer_selection(self, pm, args):
        ...
        if args.o2_optimizer:
            ...
            elif args.optimizer_selection == 'zeta':
                from mindspeed_llm.tasks.models.common.zeta import ZetaPerturbationDriven
                pm.register_patch('apex.optimizers.FusedAdam',
                                   ZetaPerturbationDriven, create_dummy=True)
            elif args.optimizer_selection == 'zetav11':
                from mindspeed_llm.tasks.models.common.zetav11 import ZetaV11
                pm.register_patch('apex.optimizers.FusedAdam',
                                   ZetaV11, create_dummy=True)
            ...
            elif args.optimizer_selection == 'adamuonsophia':
                from mindspeed_llm.tasks.models.common.adamuonsophia import AdamuonSophia                         
                pm.register_patch('apex.optimizers.FusedAdam',
                                   AdamuonSophia, create_dummy=True)
            elif args.optimizer_selection == 'lion':
                from mindspeed_llm.tasks.models.common.lion import Lion                         
                pm.register_patch('apex.optimizers.FusedAdam',
                                   Lion, create_dummy=True)
            elif args.optimizer_selection == 'lionmuon':
                from mindspeed_llm.tasks.models.common.lionmuon import LionMuon                         
                pm.register_patch('apex.optimizers.FusedAdam',
                                   LionMuon, create_dummy=True)
            elif args.optimizer_selection == 'mixmuon':
                from mindspeed_llm.tasks.models.common.mixmuon import MixMuon                         
                pm.register_patch('apex.optimizers.FusedAdam',
                                   MixMuon, create_dummy=True)
            elif args.optimizer_selection == 'adamuonstable':
                from mindspeed_llm.tasks.models.common.adamuonstable import AdaMuonStable                   
                pm.register_patch('apex.optimizers.FusedAdam',
                                   AdaMuonStable, create_dummy=True)
            elif args.optimizer_selection == 'zetasoliton':
                from mindspeed_llm.tasks.models.common.zeta_soliton import ZetaMuonSoliton                   
                pm.register_patch('apex.optimizers.FusedAdam',
                                   ZetaMuonSoliton, create_dummy=True)
            elif args.optimizer_selection == 'muonmagma':
                from mindspeed_llm.tasks.models.common.muon_magma import Muon                   
                pm.register_patch('apex.optimizers.FusedAdam',
                                   Muon, create_dummy=True)
